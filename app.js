...
Object.assign(nlUiTextMap, {
  ...
  "PrÃ©paration chantier": "Werfvoorbereiding",
  "Préparation chantier": "Werfvoorbereiding",
  "Acces": "Toegang",
  "Mode Appwrite": "Appwrite-modus",
  "Charge": "Geladen",
  "Chargement": "Laden",
  "Initialisation": "Initialisatie",
  "Connecte": "Verbonden",
  "Connexion": "Verbinding",
  "Revenir a ma vue": "Terug naar mijn weergave",
  "Revenir à ma vue": "Terug naar mijn weergave",
  "Responsable Twem": "TWEM-verantwoordelijke",
  "Detail": "Detail",
  "Telephonie": "Telefonie",
  "Electricien": "Elektricien",
  "Probleme": "Probleem",
  "Administration Twem": "TWEM-administratie",
  "Ajouter des personnes, magasins et affectations.": "Personen, winkels en toewijzingen toevoegen.",
  "Ajouter / modifier un magasin": "Winkel toevoegen / wijzigen",
  "Magasin existant": "Bestaande winkel",
  "Nouveau magasin": "Nieuwe winkel",
  "Nom magasin affiche dans les listes": "Winkelnaam in lijsten",
  "Numero magasin": "Winkelnummer",
  "NumÃ©ro magasin": "Winkelnummer",
  "Adresse": "Adres",
  "Taille magasin": "Winkelgrootte",
  "Contact magasin": "Winkelcontact",
  "Enregistrer le magasin": "Winkel opslaan",
  "Recherche contact": "Contact zoeken",
  "Recherche magasin": "Winkel zoeken",
  "Recherche rapide et modification directe.": "Snel zoeken en meteen aanpassen.",
  "Intervenants chantier": "Werfbetrokkenen",
  "Intervenant": "Betrokkene",
  "Ajouter une sorte": "Soort toevoegen",
  "Ajouter un role si besoin pour les listes deroulantes.": "Voeg indien nodig een rol toe voor de keuzelijsten.",
  "Retirer": "Verwijderen",
  "Attribuer": "Toewijzen",
  "Ouvrir aux personnes cochees": "Openen voor aangevinkte personen",
  "Ouvrir tous les acces fermes": "Alle gesloten toegangen openen",
  "Marquer tous les mails recus au 02/06/2026": "Alle mails als ontvangen markeren op 02/06/2026",
  "Derniere mise a jour": "Laatste update",
  "DerniÃ¨re mise Ã  jour": "Laatste update",
  "Aucun document importe": "Geen document geimporteerd",
  "Aucun document importÃ©": "Geen document geimporteerd",
  "Importer le plan PDF": "PDF-plan importeren",
  "Importer un ZIP": "ZIP importeren",
  "Telecharger le document": "Document downloaden",
  "TÃ©lÃ©charger le document": "Document downloaden",
  "Telecharger le ZIP": "ZIP downloaden",
  "TÃ©lÃ©charger le ZIP": "ZIP downloaden",
  "Ouvrir le PDF": "PDF openen",
  "Supprimer": "Verwijderen",
  "Remplacer le document": "Document vervangen",
  "Sauvegarder les quantites modifiees": "Gewijzigde hoeveelheden opslaan",
  "Sauvegarder les quantitÃ©s modifiÃ©es": "Gewijzigde hoeveelheden opslaan",
  "Region": "Regio",
  "RÃ©gion": "Regio",
  "Region flamande": "Vlaamse regio",
  "Region francophone": "Franstalige regio",
  ...
  "Validation manager config": "Validatie managerconfig",
  "Config magasin": "Winkelconfig",
  "Config reseau OK": "Netwerkconfig OK",
  "Config rÃ©seau OK": "Netwerkconfig OK",
  "Config reseau pas OK": "Netwerkconfig niet OK",
  "Config rÃ©seau pas OK": "Netwerkconfig niet OK",
  "Cablage OK": "Bekabeling OK",
  "Cablage pas OK": "Bekabeling niet OK",
  "Switch OK": "Switch OK",
  "Switch pas OK": "Switch niet OK",
  "Previsite pas OK": "Pre-visit niet OK",
  "Pre-visite pas OK": "Pre-visit niet OK",
  "VLAN22 pas OK": "VLAN22 niet OK",
  "Configuration complete": "Configuratie volledig",
  "Configuration incomplete": "Configuratie onvolledig",
  "Cablage a suivre": "Bekabeling op te volgen",
  "Switch a faire": "Switch te doen",
  "VLAN valide": "VLAN gevalideerd",
  "VLAN a valider": "VLAN te valideren",
  "Previsite OK": "Pre-visit OK",
  "Previsite a suivre": "Pre-visit op te volgen",
  "Ouvrir la configuration detaillee": "Gedetailleerde configuratie openen",
  "Ouvrir la configuration dÃ©taillÃ©e": "Gedetailleerde configuratie openen",
  "Lecture seule": "Alleen lezen",
  "Sauvegarde Appwrite OK": "Appwrite-opslag OK",
  "Sauvegarde locale OK": "Lokale opslag OK",
  "Erreur d'envoi": "Verzendfout",
  "Brouillon": "Concept",
  "A envoyer": "Te verzenden",
  "Envoye": "Verzonden",
  "EnvoyÃ©": "Verzonden",
  "Mail envoye": "Mail verzonden",
  "Mail envoyÃ©": "Mail verzonden",
  "Mail recu": "Mail ontvangen",
  "Mail reÃ§u": "Mail ontvangen",
  "A depecher": "Te dispatchen",
  "A dispatcher": "Te dispatchen",
  "Dispatch TWEM": "Dispatch TWEM",
  "Transferer / assigner": "Doorsturen / toewijzen",
  "TransfÃ©rer / assigner": "Doorsturen / toewijzen",
  "Message de transfert": "Doorstuurbericht",
  "Historique de traitement": "Behandelhistoriek",
  "Demande initiale": "Initiële aanvraag",
  "Aucun suivi ajoute pour le moment.": "Nog geen opvolging toegevoegd.",
  "Aucun suivi ajoutÃ© pour le moment.": "Nog geen opvolging toegevoegd.",
  "Nouveau suivi": "Nieuwe opvolging",
  "Ajouter le suivi": "Opvolging toevoegen",
  "Statut du ticket": "Ticketstatus"
});

Object.assign(nlUiTextMap, {
  "A definir": "Te bepalen",
  "A dÃ©finir": "Te bepalen",
  "Modele appareil": "Toestelmodel",
  "ModÃ¨le appareil": "Toestelmodel",
  "Extension liee": "Gekoppelde extensie",
  "Extension liÃ©e": "Gekoppelde extensie",
  "Numero mobile": "Mobiel nummer",
  "NumÃ©ro mobile": "Mobiel nummer",
  "Reseau mobile": "Mobiel netwerk",
  "RÃ©seau mobile": "Mobiel netwerk",
  "Groupe appel": "Oproepgroep",
  "Ajouter un GSM": "GSM toevoegen",
  "Sauvegarder les GSM": "GSM's opslaan",
  "Groupes d'appel / secteurs qui sonnent ensemble": "Oproepgroepen / zones die samen rinkelen",
  "Validation / remarque groupes d'appel": "Validatie / opmerking oproepgroepen",
  "Validation / remarque cascades": "Validatie / opmerking cascades",
  "Coordination Destiny": "Coordinatie Destiny",
  "Reference ticket Destiny": "Ticketreferentie Destiny",
  "Numero de dossier Destiny": "Dossiernummer Destiny",
  "NumÃ©ro de dossier Destiny": "Dossiernummer Destiny",
  "PM installateur Destiny": "PM installateur Destiny",
  "Mail PM installateur": "Mail PM installateur",
  "Liste diffusion minimale": "Minimale distributielijst",
  "Pre-visite Destiny": "Pre-visit Destiny",
  "Verification reseau sur site": "Netwerkcontrole ter plaatse",
  "VÃ©rification rÃ©seau sur site": "Netwerkcontrole ter plaatse",
  "Remarque premiere visite": "Opmerking eerste bezoek",
  "Remarque premiÃ¨re visite": "Opmerking eerste bezoek",
  "Configuration demandee au magasin": "Configuratie gevraagd aan de winkel",
  "Configuration demandÃ©e au magasin": "Configuratie gevraagd aan de winkel",
  "Mail configuration envoye": "Configuratiemail verzonden",
  "Mail configuration envoyÃ©": "Configuratiemail verzonden",
  "Configuration extensions recue": "Extensieconfiguratie ontvangen",
  "Configuration extensions reÃ§ue": "Extensieconfiguratie ontvangen",
  ...
  "Verification mobile": "Mobiele controle",
  "VÃ©rification mobile": "Mobiele controle",
  "Choix operateur mobile": "Keuze mobiele operator",
  "Choix opÃ©rateur mobile": "Keuze mobiele operator",
  "Note preparation externe": "Opmerking externe voorbereiding",
  "Note prÃ©paration externe": "Opmerking externe voorbereiding",
  "Alarme geree par IT": "Alarm beheerd door IT",
  "Alarme gÃ©rÃ©e par IT": "Alarm beheerd door IT",
  "VLAN22 active": "VLAN22 actief",
  "VLAN22 activÃ©": "VLAN22 actief",
  "Charles Roux - cablage": "Charles Roux - bekabeling",
  "Charles Roux - cÃ¢blage": "Charles Roux - bekabeling",
  "Cablage sur site": "Bekabeling ter plaatse",
  "CÃ¢blage sur site": "Bekabeling ter plaatse",
  "Chargeurs mobiles envoyes": "Mobiele laders verzonden",
  "Chargeurs mobiles envoyÃ©s": "Mobiele laders verzonden",
  "Nombre de chargeurs requis": "Aantal vereiste laders",
  "Retour Brico / bascule suite": "Feedback Brico / verdere omschakeling",
  "Remarques finales Brico": "Eindopmerkingen Brico",
  "Switch plateforme LT": "Switch platform LT",
  "Derniere maj": "Laatste update",
  "DerniÃ¨re maj": "Laatste update",
  "Actuelle": "Huidig",
  "Cible": "Doel",
  "Video a ajouter": "Video toe te voegen",
  "VidÃ©o Ã  ajouter": "Video toe te voegen",
  "Fiches techniques": "Technische fiches",
  "Titre": "Titel",
  "Theme": "Thema",
  "ThÃ¨me": "Thema",
  "Resume court": "Korte samenvatting",
  "RÃ©sumÃ© court": "Korte samenvatting",
  "Texte de la fiche": "Tekst van de fiche",
  "Point d'attention": "Aandachtspunt",
  "Annuler": "Annuleren",
  "Enregistrer la fiche": "Fiche opslaan",
  "Creer la fiche": "Fiche aanmaken",
  "CrÃ©er la fiche": "Fiche aanmaken",
  "Aucune fiche technique pour le moment.": "Nog geen technische fiche.",
  "Tutoriels d'utilisation": "Gebruikstutorials",
  "Probleme de telephonie": "Telefonieprobleem",
  "ProblÃ¨me de tÃ©lÃ©phonie": "Telefonieprobleem",
  "Probleme d'app": "App-probleem",
  "Detail commande": "Besteldetail",
  "Quantite": "Hoeveelheid",
  "QuantitÃ©": "Hoeveelheid",
  "Statut cde": "Bestelstatus",
  "Cde approuvee": "Bestelling goedgekeurd",
  "Cde approuvÃ©e": "Bestelling goedgekeurd",
  "N commande": "Bestelnummer",
  "Livre": "Geleverd",
  "LivrÃ©": "Geleverd",
  "Aucun ticket SAV ne correspond aux filtres.": "Geen SAV-ticket komt overeen met de filters.",
  "Mettre a jour": "Bijwerken",
  "Mettre Ã  jour": "Bijwerken",
  "Categorie": "Categorie",
  ...
  "Libelle": "Label",
  "LibellÃ©": "Label",
  "Libelle / lieu": "Label / plaats",
  "LibellÃ© / lieu": "Label / plaats",
  "Ancien": "Oud",
  "Ancien nÂ°": "Oud nr.",
  "Usage": "Gebruik",
  "Aucune extension ne correspond a la recherche.": "Geen extensie komt overeen met de zoekopdracht.",
  "Aucune extension ne correspond Ã  la recherche.": "Geen extensie komt overeen met de zoekopdracht.",
  "Reference complete des extensions disponibles": "Volledige referentie van beschikbare extensies",
  "RÃ©fÃ©rence complÃ¨te des extensions disponibles": "Volledige referentie van beschikbare extensies",
  "Bouton d appel": "Oproepknop",
  "Bouton d'appel": "Oproepknop",
  "Bouton panique": "Paniekknop",
  "Ajouter extension": "Extensie toevoegen",
  "Libelle FR": "Label FR",
  "LibellÃ© FR": "Label FR",
  "Libelle NL": "Label NL",
  "LibellÃ© NL": "Label NL",
  "Libelle EN": "Label EN",
  "LibellÃ© EN": "Label EN",
  "Modeles possibles": "Mogelijke modellen",
  "ModÃ¨les possibles": "Mogelijke modellen",
  "ligne(s)": "lijn(en)",
  "ligne(s) du tableau ConfigVoIPExt": "lijn(en) uit de ConfigVoIPExt-tabel",
  "Cet onglet est reserve a Emir et Valou.": "Deze tab is voorbehouden aan Emir en Valou.",
  "Cet onglet est rÃ©servÃ© Ã  Emir et Valou.": "Deze tab is voorbehouden aan Emir en Valou.",
  "Edition massive des quantites": "Massale bewerking van hoeveelheden",
  "Edition massive des quantitÃ©s": "Massale bewerking van hoeveelheden",
  "Aucun magasin ne correspond aux filtres.": "Geen winkel komt overeen met de filters.",
  "Aucun rapport magasin disponible pour le moment.": "Nog geen winkelrapport beschikbaar.",
  "Exporter PDF": "PDF exporteren",
  "Type magasin": "Winkeltype",
  "Personne precise": "Specifieke persoon",
  "Personne prÃ©cise": "Specifieke persoon",
  "FOS uniquement": "Alleen FOS",
  "FOSDOS uniquement": "Alleen FOSDOS",
  "Personne": "Persoon",
  "Objet du mail": "Onderwerp van de mail",
  "Corps du mail": "Mailtekst",
  "Reinitialiser le brouillon": "Concept resetten",
  "Reinitialiser le brouillon": "Concept resetten",
  "Copier destinataires + texte": "Ontvangers + tekst kopieren",
  "destinataire(s)": "ontvanger(s)",
  "Aucun contact avec mail et PIN actif pour cette selection.": "Geen contact met mail en actieve PIN voor deze selectie.",
  "Aucun mail automatique prepare pour le moment.": "Nog geen automatische mail voorbereid.",
  "Selon declencheur": "Volgens trigger",
  "Selon dÃ©clencheur": "Volgens trigger",
  "Destinataires supplementaires du digest": "Extra ontvangers van de digest",
  "Lien cible": "Doellink",
  "Canal": "Kanaal",
  "Declencheur": "Trigger",
...
Object.assign(nlUiPhraseMap, {
  "Suivi partage en direct entre planning chantier, rendez-vous, remontees et rapports.": "Live gedeelde opvolging tussen werfplanning, afspraken, updates en rapporten.",
  "Suivi partagÃ© en direct entre planning chantier, rendez-vous, remontÃ©es et rapports.": "Live gedeelde opvolging tussen werfplanning, afspraken, updates en rapporten.",
  "De la demande de configuration jusqu au choix final des extensions.": "Van configuratieaanvraag tot de definitieve keuze van extensies.",
  "De la demande de configuration jusqu'au choix final des extensions.": "Van configuratieaanvraag tot de definitieve keuze van extensies.",
  "La configuration ci-dessous est peut etre differente en quantite, ceci est tout a fait normal, les quantites ont ete revues avec Brico": "De onderstaande configuratie kan qua hoeveelheden verschillen. Dat is normaal: de hoeveelheden werden samen met Brico herzien",
  "La configuration ci-dessous est peut-etre differente en quantite, ceci est tout a fait normal, les quantites ont ete revues avec Brico": "De onderstaande configuratie kan qua hoeveelheden verschillen. Dat is normaal: de hoeveelheden werden samen met Brico herzien",
  "les numeros d extension ont egalement change pour certains points dans le but que la telephonie soit uniformisee dans tout les magasins": "ook de extensienummers zijn voor sommige punten gewijzigd om de telefonie in alle winkels te uniformiseren",
  "Le responsable magasin remplit cette partie pour permettre a l IT de programmer les appareils avant installation.": "De winkelverantwoordelijke vult dit deel in zodat IT de toestellen voor de installatie kan programmeren.",
  "Le responsable magasin remplit cette partie pour permettre a l'IT de programmer les appareils avant installation.": "De winkelverantwoordelijke vult dit deel in zodat IT de toestellen voor de installatie kan programmeren.",
  "Le magasin remplit ses choix puis confirme en bas du module.": "De winkel vult zijn keuzes in en bevestigt onderaan de module.",
  "Les choix telephonie sont complets": "De telefoniekeuzes zijn volledig",
  "Le choix d extension est libre": "De extensiekeuze is vrij",
  "Demande initiale par": "Initiële aanvraag door",
  "Aucun ticket SAV pour ce magasin pour le moment.": "Nog geen SAV-ticket voor deze winkel.",
  "Explique ce qui est attendu avant de transferer le SAV.": "Leg uit wat verwacht wordt voordat de SAV wordt doorgestuurd.",
  "Ajoute ici le suivi, la reponse, la correction ou l etat d avancement": "Voeg hier de opvolging, het antwoord, de correctie of de voortgang toe",
  "Ajoute ici le suivi, la rÃ©ponse, la correction ou l'Ã©tat d'avancement": "Voeg hier de opvolging, het antwoord, de correctie of de voortgang toe",
  "Obligatoire si statut bloque": "Verplicht als de status geblokkeerd is",
  "Obligatoire si statut bloquÃ©": "Verplicht als de status geblokkeerd is",
  "Probleme constate, element a corriger, reserve de fin": "Vastgesteld probleem, te corrigeren punt, eindvoorbehoud",
  "ProblÃ¨me constatÃ©, Ã©lÃ©ment Ã  corriger, rÃ©serve de fin": "Vastgesteld probleem, te corrigeren punt, eindvoorbehoud",
  "Aucune remarque enregistree.": "Geen opmerking opgeslagen.",
  "Aucune remarque enregistrÃ©e.": "Geen opmerking opgeslagen.",
  "La remarque sera horodatee avec ton nom lors de la sauvegarde.": "De opmerking krijgt datum, uur en jouw naam bij het opslaan.",
  "La remarque sera horodatÃ©e avec ton nom lors de la sauvegarde.": "De opmerking krijgt datum, uur en jouw naam bij het opslaan.",
  "Date installation Destiny": "Installatiedatum Destiny",
  "Reference ticket": "Ticketreferentie",
  "RÃ©fÃ©rence ticket": "Ticketreferentie",
  "Date VLAN22": "Datum VLAN22",
  "Date cablage": "Datum bekabeling",
  "Date cÃ¢blage": "Datum bekabeling",
  "Date switch": "Datum switch",
  "Date presentoir": "Datum display",
  "Date prÃ©sentoir": "Datum display",
  "Date stickers": "Datum stickers",
  "Nouvelle remarque preparation externe": "Nieuwe opmerking externe voorbereiding",
  "Nouvelle remarque prÃ©paration externe": "Nieuwe opmerking externe voorbereiding",
  "Nouvelle remarque installation": "Nieuwe opmerking installatie",
  "Nouvelle remarque presentoir": "Nieuwe opmerking display",
  "Nouvelle remarque prÃ©sentoir": "Nieuwe opmerking display",
  "Nouvelle remarque sticker": "Nieuwe opmerking sticker",
  "Sauvegarder la preparation": "Voorbereiding opslaan",
  "Sauvegarder la prÃ©paration": "Voorbereiding opslaan",
  "Sauvegarder ce bloc": "Blok opslaan",
  "Sauvegarder presentoirs / stickers": "Displays / stickers opslaan",
  "Sauvegarder prÃ©sentoirs / stickers": "Displays / stickers opslaan",
  "Type d alarme": "Type alarm",
  "Type d'alarme": "Type alarm",
  "Tel centrale alarme": "Telefoon alarmcentrale",
  "Groupes d appel": "Oproepgroepen",
  "Groupes d'appel": "Oproepgroepen",
  "Si ces extensions sonnent": "Als deze extensies rinkelen",
  "tous les telephones de ce secteur sonnent": "rinkelen alle telefoons van die zone",
  "jusqu au premier qui decroche": "tot iemand opneemt",
  "si on decroche la ligne elle est redirigee vers un autre poste": "als er niet wordt opgenomen, wordt de lijn doorgestuurd naar een ander toestel",
  "elle revient au poste initial": "ze keert terug naar het oorspronkelijke toestel",
  "Exemple": "Voorbeeld",
  "Aucune ligne configuree": "Geen lijn geconfigureerd",
  "Aucune ligne configurÃ©e": "Geen lijn geconfigureerd",
  "Choisir une extension / un lieu": "Kies een extensie / locatie",
  "personnaliser la touche / commentaire": "toets personaliseren / opmerking",
  "Sauvegarder ce bloc": "Blok opslaan"
});

Object.assign(nlUiPlaceholderMap, {
  "Ex: acces reserve prevu": "Bv: gereserveerde toegang voorzien",
  "Ex: accÃ¨s rÃ©servÃ© prÃ©vu": "Bv: gereserveerde toegang voorzien",
  "Ex: poste caisse, GSM, transfert, VLAN, accueil": "Bv: kassatoestel, GSM, doorschakeling, VLAN, onthaal",
  "Ex: DST-2026-0412": "Bv: DST-2026-0412",
  "dd/mm/yyyy": "dd/mm/jjjj",
  "Ex: personnaliser la touche / commentaire": "Bv: toets personaliseren / opmerking",
  "Decris le probleme, le besoin ou le contexte de la demande SAV": "Beschrijf het probleem, de behoefte of de context van de SAV-aanvraag",
  "DÃ©cris le problÃ¨me, le besoin ou le contexte de la demande SAV": "Beschrijf het probleem, de behoefte of de context van de SAV-aanvraag",
  "Ex: groupe accueil OK, groupe caisse a verifier": "Bv: groep onthaal OK, groep kassa te controleren",
  "Ex: cascade centrale OK, accueil a verifier": "Bv: cascade centrale OK, onthaal te controleren",
  "Note / suivi": "Opmerking / opvolging",
  "Ex: dossier installation": "Bv: installatiedossier",
  "Nom du PM": "Naam van de PM",
  "3 personnes minimum": "Minstens 3 personen",
  "Probleme releve, action a mettre en place, adaptation necessaire": "Vastgesteld probleem, nodige actie, noodzakelijke aanpassing",
  "ProblÃ¨me relevÃ©, action Ã  mettre en place, adaptation nÃ©cessaire": "Vastgesteld probleem, nodige actie, noodzakelijke aanpassing",
  "Appuyez sur 1, appuyez sur 2, consignes, routage, remarques libres": "Druk op 1, druk op 2, instructies, routering, vrije opmerkingen",
  "Texte libre sur les souhaits du magasin": "Vrije tekst over de wensen van de winkel",
  "Probleme constate, element a corriger, reserve de fin": "Vastgesteld probleem, te corrigeren punt, eindvoorbehoud",
  "ProblÃ¨me constatÃ©, Ã©lÃ©ment Ã  corriger, rÃ©serve de fin": "Vastgesteld probleem, te corrigeren punt, eindvoorbehoud",
  "Element qui pourrait encore ne pas fonctionner, remarque post-installation": "Punt dat mogelijk nog niet werkt, opmerking na installatie",
  "Ex: Faire un transfert d'appel": "Bv: Een doorschakeling doen",
  "Ex: Telephone fixe, Call button, SAV": "Bv: Vast toestel, call button, SAV",
  "Une phrase pour expliquer a quoi sert la fiche": "Een zin om uit te leggen waarvoor de fiche dient",
  "Ecris ici les etapes, consignes, cas particuliers...": "Schrijf hier de stappen, instructies en uitzonderingen...",
  "Optionnel: attention, exception, info importante": "Optioneel: aandachtspunt, uitzondering, belangrijke info",
  "Coller le lien Google Drive": "Google Drive-link plakken",
  "Detail commande": "Besteldetail",
  "N commande": "Bestelnummer",
  "Modele": "Model",
  "ModÃ¨le": "Model",
  ...
  "Explique ce qui est attendu avant de transferer le SAV.": "Leg uit wat verwacht wordt voordat de SAV wordt doorgestuurd.",
  "Ajoute ici le suivi, la reponse, la correction ou l etat d avancement": "Voeg hier de opvolging, het antwoord, de correctie of de voortgang toe",
  "Ex: BRI-001": "Bv: BRI-001"
});

Object.assign(nlUiPhraseMap, {
  "Lien video sauvegarde localement, mais la synchronisation distante a echoue.": "Videolink lokaal opgeslagen, maar de synchronisatie op afstand is mislukt.",
  "Fiche sauvegardee localement, mais la synchronisation distante a echoue.": "Fiche lokaal opgeslagen, maar de synchronisatie op afstand is mislukt.",
  "Indique au minimum un titre et le texte de la fiche.": "Vul minstens een titel en de tekst van de fiche in.",
  "La categorie et le numero sont obligatoires.": "Categorie en nummer zijn verplicht.",
  "Extension ajoutee localement, mais la synchronisation distante a echoue.": "Extensie lokaal toegevoegd, maar de synchronisatie op afstand is mislukt.",
  "Aucun destinataire pour cette selection.": "Geen ontvanger voor deze selectie.",
  "Destinataires et texte copies.": "Ontvangers en tekst gekopieerd.",
  "La fenetre d'envoi a ete bloquee par le navigateur.": "Het verzendvenster werd door de browser geblokkeerd.",
  "Aucun acces ferme a rouvrir.": "Geen gesloten toegang om opnieuw te openen.",
  "Coche au moins une personne.": "Vink minstens een persoon aan.",
  "Aucun contact PIN a mettre a jour.": "Geen PIN-contact om bij te werken.",
  "Il faut une adresse mail et un PIN a 6 chiffres avant d'envoyer.": "Er is een e-mailadres en een PIN van 6 cijfers nodig voordat je kan verzenden.",
  "L envoi de lien magique est desactive pour le moment.": "Het verzenden van magische links is momenteel uitgeschakeld.",
  "Configure Appwrite pour envoyer un lien magique.": "Configureer Appwrite om een magische link te verzenden.",
  "Configure Supabase pour envoyer un lien magique.": "Configureer Supabase om een magische link te verzenden.",
  "Aucun document n'est enregistre pour ce magasin.": "Er is geen document opgeslagen voor deze winkel.",
  "Impossible de construire le lien Appwrite Storage.": "Kan de Appwrite Storage-link niet maken.",
  "Impossible de telecharger ce ZIP.": "Kan deze ZIP niet downloaden.",
  "Impossible d'ouvrir ou de telecharger ce document.": "Kan dit document niet openen of downloaden.",
  "Utilise uniquement un fichier PDF ou ZIP pour les plans magasin.": "Gebruik alleen een PDF- of ZIP-bestand voor winkelplannen.",
  "Le document est trop lourd. Garde un fichier inferieur a 10 Mo.": "Het document is te zwaar. Gebruik een bestand kleiner dan 10 MB.",
  "Choisis au moins une personne pour dispatcher le SAV.": "Kies minstens een persoon om de SAV te dispatchen.",
  "Ce PIN est deja attribue a une autre personne.": "Deze PIN is al aan iemand anders toegewezen.",
  "Nom, ville et code sont obligatoires pour enregistrer le magasin.": "Naam, stad en code zijn verplicht om de winkel op te slaan.",
  "Magasin modifie et enregistre.": "Winkel gewijzigd en opgeslagen.",
  "Magasin cree et enregistre.": "Winkel aangemaakt en opgeslagen.",
  "Lien de connexion envoye.": "Loginlink verzonden.",
  "Envoi impossible": "Verzenden onmogelijk",
  "PIN attribue a": "PIN toegekend aan",
  "Intervenant modifie localement, mais la synchro Appwrite a echoue. Retente apres refresh si besoin.": "Betrokkene lokaal gewijzigd, maar Appwrite-synchronisatie is mislukt. Probeer opnieuw na refresh indien nodig.",
  "Sorte d'intervenant ajoutee localement, mais la synchro Appwrite a echoue": "Soort betrokkene lokaal toegevoegd, maar Appwrite-synchronisatie is mislukt",
  "Magasin garde localement, mais Appwrite a refuse la synchro": "Winkel lokaal bewaard, maar Appwrite heeft de synchronisatie geweigerd"
});

if (typeof window !== "undefined" && !window.__twemAlertLocalized) {
  const nativeAlert = window.alert.bind(window);
  window.alert = (message) => {
    const text = String(message ?? "");
    const isNl = typeof state !== "undefined" && state.language === "nl";
    nativeAlert(isNl ? translateUiTextValue(text) : text);
  };
  window.__twemAlertLocalized = true;
}
...
const cancelledInstallCorrections20260609 = {
  "BRI-3621": "2026-06-09",
  "BRI-5430": "2026-06-09",
  "BRI-3597": "2026-06-16"
};

function applyCancelledInstallCorrections() {
  const note = "Installation annulee - une nouvelle date sera transmise ulterieurement.";
  const changedStores = [];
  (state.stores || []).forEach((store) => {
    const cancelledDate = cancelledInstallCorrections20260609[store.code];
    if (!cancelledDate) {
      return;
    }
    const workflow = ensureStoreWorkflowData(store);
    if (normalizeDateOnly(workflow.destinyInstallDate) !== cancelledDate) {
      return;
    }
    workflow.destinyInstallDate = "";
    workflow.destinyInstallDone = "Non";
    workflow.destinyInstallRemark = note;
    if (!Array.isArray(workflow.installationRemarks)) {
      workflow.installationRemarks = [];
    }
    const hasNote = workflow.installationRemarks.some((remark) => normalizeImportCell(remark?.text) === note);
    if (!hasNote) {
      workflow.installationRemarks.push({
        id: `remark-cancel-20260609-${store.code}`,
        text: note,
        author: "Valou / TWEM",
...
function automationEmailTemplate(automation, context = {}) {
  if (automation.id === "daily_operations_digest") {
    return {
      subject: "Rapport activite TWEM Brico",
...
function digestStoreCode(store = {}) {
  return normalizeImportCell(store.shopNumber)
    || normalizeImportCell(store.code).replace(/^BRI-?/i, "")
    || normalizeImportCell(store.name)
    || "-";
}
...
function digestStoreKeySet(store = {}) {
  return new Set([
    normalizeImportCell(store.code).toUpperCase(),
    normalizeImportCell(store.shopNumber).toUpperCase(),
    normalizeImportCell(store.name).toUpperCase()
  ].filter(Boolean));
}
...
function pendingInstallationCancellationForStore(store = {}) {
  ...
  return PENDING_INSTALLATION_CANCELLATIONS.find((entry) =>
    entry.codes.some((code) => keys.has(normalizeImportCell(code).toUpperCase()))
  );
}
...
function pendingInstallationCancellationLines(stores = []) {
  ...
  const fallbackLines = PENDING_INSTALLATION_CANCELLATIONS
    .filter((entry) => !entry.codes.some((code) => knownStoreCodes.has(normalizeImportCell(code).replace(/^BRI-?/i, ""))))
    .map((entry) => entry.label);
  return uniqueDigestList([...storeLines, ...fallbackLines].map((line) => `${line} : date a transmettre ulterieurement`));
}

function digestDateKey(value) {
  const date = normalizeDateOnly(value);
  if (!date) {
    return "";
  }
...
function digestUpcomingInstallationLines(stores = [], startDate = new Date(), days = 5) {
  ...
  stores.forEach((store) => {
    if (isPendingInstallationCancellation(store)) {
      return;
    }
    const installDate = normalizeDateOnly(ensureStoreWorkflowData(store).destinyInstallDate);
    if (!installDate || installDate < start || installDate > end) {
      return;
    }
    const key = digestDateKey(installDate);
...
function isDigestDay(value, day) {
  const date = normalizeDateOnly(value);
  return Boolean(date && day && isSameLocalDay(date, day));
}

function digestActivityDayItems(day) {
  return (state.activities || []).filter((activity) => isDigestDay(activity.createdAt, day));
}

function digestChangedStores(day) {
  const activityStoreKeys = new Set(digestActivityDayItems(day).flatMap((activity) => [
    normalizeImportCell(activity.storeCode),
    normalizeImportCell(activity.storeName)
  ].filter(Boolean)));
  return (state.stores || []).filter((store) =>
    isDigestDay(store.updatedAt, day)
    || isDigestDay(ensureStoreWorkflowData(store).planPdfUpdatedAt, day)
    || activityStoreKeys.has(normalizeImportCell(store.code))
    || activityStoreKeys.has(normalizeImportCell(store.name))
  );
}

function digestStatusBlocked(value) {
  return ["bloque", "bloquee", "probleme"].includes(normalizeRoleKey(value));
}

function digestNetworkConfigSummary(store) {
  const rows = getNetworkConfigRows(store);
  const configured = rows.filter((row) => normalizeImportCell(row.extensionLabel)).length;
...
function buildDailyActivityDigestBody() {
  const reportDay = digestReportDay();
  const today = new Date();
  today.setHours(0, 0, 0, 0);
  const tomorrow = new Date(today);
  tomorrow.setDate(tomorrow.getDate() + 1);
  const changedStores = digestChangedStores(reportDay);
  const activities = digestActivityDayItems(reportDay);
  const activityForStore = (store, matcher) => activities.some((activity) =>
    [store.code, store.name].some((key) => normalizeImportCell(key) && normalizeImportCell(activity.storeCode || activity.storeName).includes(normalizeImportCell(key)))
    && matcher(normalizeImportCell(activity.comment).toLowerCase())
  );

  const preparationStores = changedStores.filter((store) => {
    const workflow = ensureStoreWorkflowData(store);
    return normalizeImportCell(workflow.vlan22Activated)
      || normalizeImportCell(workflow.vlan22Date)
      || normalizeImportCell(workflow.cablingStatus)
      || normalizeImportCell(workflow.cablingDate)
      || normalizeImportCell(workflow.ltSwitchStatus)
      || normalizeImportCell(workflow.ltSwitchDate)
  ...
  const installToday = (state.stores || [])
    ...
    .map((store) => digestStoreLine(store, ensureStoreWorkflowData(store).destinyInstallDate));
  const installTomorrow = (state.stores || [])
    .filter((store) => isDigestDay(ensureStoreWorkflowData(store).destinyInstallDate, tomorrow))
    .filter((store) => !isPendingInstallationCancellation(store))
    .map((store) => digestStoreLine(store, ensureStoreWorkflowData(store).destinyInstallDate));
  const installUpcoming = digestUpcomingInstallationLines(state.stores || [], tomorrow, 5);
  const installCancelled = uniqueDigestList([
    ...pendingInstallationCancellationLines(state.stores || []),
    ...activities
  ...
  const savClosed = (state.tickets || []).filter((ticket) =>
    ...
    && (isDigestDay(ticket.updatedAt, reportDay) || (ticket.updates || []).some((update) => isDigestDay(update.createdAt, reportDay) && /clot|closed/i.test(update.note || "")))
  ).map(digestTicketLine);
  const savInProgress = (state.tickets || []).filter((ticket) =>
    ["open", "in_progress", "assigned", "dispatch"].includes(ticket.status)
    && (isDigestDay(ticket.updatedAt, reportDay) || (ticket.updates || []).some((update) => isDigestDay(update.createdAt, reportDay)))
  ).map(digestTicketLine);

  const addedPlans = (state.stores || [])
  ...
  return [
    "Digest du jour :",
    "",
    `Rapport activite de la journee d'hier : ${digestDateLabel(reportDay)}`,
    "",
...
function buildDailyOperationsDigestBody() {
  return buildDailyActivityDigestBody();
}
  ...
  if (isAppwriteMode && appwriteAccount) {
    try {
      ...
      if (hasAppwriteDataConfig) {
        ...
        const cancelledInstallStores = applyCancelledInstallCorrections();
        if (cancelledInstallStores.length) {
          saveState();
          for (const store of cancelledInstallStores) {
            await syncStoreToRemote(store);
          }
          refreshRemoteSyncShadow();
        }
